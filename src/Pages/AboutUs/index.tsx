...
import { Container, CardHeader, Card, Title, TitleInfo, Image, DescriptionInfo, Contacts, ContactsInfo, Team, Dev, DevInfo } from "./styles";
...
const AboutUs: React.FC = () => {
  return (
    <Container>
      ...
      <Team>
        <TitleInfo><h2> Desenvolvedores </h2></TitleInfo>
        <DescriptionInfo>
            <ul>
              <li> Letícia</li>
              <li> Letícia</li>
