...
import { Container, CardHeader, Card, Title, TitleInfo, Image, DescriptionInfo, Contacts, ContactsInfo, CardContainer } from "./styles";
    ...
    <Container>
      ...
      <CardContainer>  
        ...
        <Card>    
          ...
          <Contacts>       
            <Image>
              <a href="https://www.facebook.com/PNCSA"> 
                <img src= "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Facebook_icon_2013.svg/300px-Facebook_icon_2013.svg.png" width="60" height="60"/> 
              </a>
            </Image>
          ...
          <Contacts>       
            <Image>
              <a href="http://novacartografiasocial.com/contate-nos/"> 
                <img src= "https://portal.ifba.edu.br/barreiras/imagens-campus-barreiras/icon-email.png/@@images/2272be23-02eb-43ca-9fad-f6fa02970ba3.png" width="60" height="60"/> 
              </a>
            </Image>
          ...
          <Contacts>       
            <Image>
              <img src= "https://upload.wikimedia.org/wikipedia/commons/6/6c/Phone_icon.png" width="60" height="60"/> 
            </Image>
          ...
          <Contacts>       
            <Image>
              <a href="https://goo.gl/maps/SHD5w"> 
                <img src= "https://travelpedia.com.br/wp-content/uploads/2017/11/home-icon.png" width="60" height="60"/> 
              </a>
            </Image>
